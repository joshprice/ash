defmodule Mix.Tasks.Ash.Init.ProjectPatchers.Formatter do
  @moduledoc false

  alias Mix.Tasks.Ash.Init.FilePatchers

  @behaviour Mix.Tasks.Ash.Init.ProjectPatcher
  ...
  def add_formatter_plugin_to_formatter_config() do
    %{
      name: "Add Ash.Formatter.Plugin to :plugins",
      patch: &FilePatchers.Formatter.add_plugin(&1, "Ash.Formatter.Plugin"),
      instructions: """
      In case you'll be using `mix format`, make sure you add `Ash.Formatter.Plugin`
